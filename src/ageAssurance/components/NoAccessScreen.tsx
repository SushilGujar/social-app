                ...
                {isAARegion ? (
                  <>
                    <View style={[a.gap_lg]}>
                      ...
                      <Text style={[textStyles]}>
                        <Trans>
                          You are accessing Pulse from a region that legally
                      ...
                      {!aa.flags.isOverRegionMinAccessAge && (
                        <Text style={[textStyles]}>
                          <Trans>
                            ...
                            are not old enough to access Pulse in your region.
                          </Trans>
                        </Text>
                      )}
                  ...
                  <View style={[a.gap_lg]}>
                    <Text style={[textStyles]}>
                      <Trans>
                        ...
                        profile makes you too young to access Pulse.
                      </Trans>
                    </Text>
      ...
      <View style={[a.gap_xl]}>
        {isBlocked ? (
          <Admonition type="warning">
            <Trans>
              You are currently unable to access Pulse's Age Assurance flow.
              Please{' '}
              <SimpleInlineLinkText
