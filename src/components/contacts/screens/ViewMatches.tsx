      ...
      case 'no matches header':
        return (
          <Header
            ...
            subtitleText={
              <Trans>
                Pulse is more fun with friends. Do you want to invite some of
                yours?{' '}
                <InviteInfo
    ...
    <View style={[gutter, a.py_md, a.border_t, t.atoms.border_contrast_low]}>
      <ProfileCard.Header>
        ...
        {phoneNumber && currentAccount && (
          <Button
            label={_(msg`Invite ${name} to join Pulse`)}
            color="secondary"
            size="small"
            onPress={async () => {
              ...
              try {
                await SMS.sendSMSAsync(
                  [phoneNumber],
                  _(
                    msg`I'm on Pulse as ${currentAccount.handle} - come find me!`,
                  ),
                )
              } catch (err) {
